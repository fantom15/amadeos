        ...
        <div class="col-md-12">
            <div class="col-12 bg-grey mt-5 px-4 py-5" style="min-height: 50vh; border-radius: 20px">
                <div class="col-12">
                    <div class="row">
                        <div class="col-6">
                            <h3 style="font-weight: bolder;"><?= $folder ?> Gallery</h3>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <?php foreach ($images->result_array() as $image) : ?>
                            <div class="col-md-4 p-2" style="border: 1px solid #eee; text-align: center;">
                                <img src="assets/img/images_list/<?= $image['image_name'] ?>" style="max-width: 100%; max-height: 300px;">
                                <br>
                                <p class="mt-2" style="font-size: 12px"><?= base_url() . 'assets/img/images_list/' . $image['image_name'] ?></span>
                            </div>
                        <?php endforeach; ?>
                    </div>
                </div>
